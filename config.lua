...
Config.Shops = {
    ['pdm'] = {
        ...
        ['VehicleSpawn'] = vector4(-9.44, -1082.5, 26.76, 66.61), -- Spawn location when vehicle is bought
        ['TestDriveSpawn'] = vector4(-9.44, -1082.5, 26.76, 66.61), -- Spawn location for test drive
        ['ShowroomVehicles'] = {
            [1] = {
